...
class CamFestivalSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // -------------------------------------------------------------
        // 1. SEED PARISHES & DEANERIES (17 Parishes across 3 Deaneries)
        // -------------------------------------------------------------
        $parishesData = [
            // Livingstone Deanery
            [
            ...
            [
                ...
                'code' => 'CTK',
                'deanery' => 'Livingstone Deanery',
                'patron_matron_name' => 'Maramba Youth Patron',
                'patron_contact' => '+260977881122',
                'camp_contingent_count' => 28,
                'camp_checked_in' => true,
            ],
            [
                'name' => 'Holy Childhood Parish',
                'code' => 'HCP',
                'deanery' => 'Livingstone Deanery',
                'patron_matron_name' => 'Holy Childhood Patron',
            ...
            [
                ...
                'code' => 'KZP',
                'deanery' => 'Livingstone Deanery',
                'patron_matron_name' => 'Kazungula Youth Matron',
            ...
            [
                ...
                'code' => 'MRP',
                'deanery' => 'Livingstone Deanery',
                'patron_matron_name' => 'Dambwa Youth Patron',
            ...
            [
                ...
                'code' => 'SFP',
                'deanery' => 'Livingstone Deanery',
                'patron_matron_name' => 'Libuyu Youth Patron',
            ...
            [
                ...
                'code' => 'SPP',
                'deanery' => 'Livingstone Deanery',
                'patron_matron_name' => 'Airport Youth Matron',
            ...
            [
                ...
                'code' => 'STP',
                'deanery' => 'Livingstone Deanery',
                'patron_matron_name' => 'St. Thomas Patron',
            ...
            // Sesheke Deanery
            [
                'name' => "St. Kizito's Sesheke Parish",
                'code' => 'SKS',
            ...
            [
                'name' => "St. Fidelis' Sichili Parish",
                'code' => 'SFS',
                'deanery' => 'Sesheke Deanery',
            ...
            [
                'name' => "St. Mary's Njoko Parish",
                'code' => 'SMN',
                'deanery' => 'Sesheke Deanery',
                'patron_matron_name' => 'Njoko Youth Matron',
                'patron_contact' => '+260978223344',
                'camp_contingent_count' => 22,
                'camp_checked_in' => false,
            ],
            [
                'name' => "St. Arnold Janssen's Mwandi Parish",
                'code' => 'SAJ',
                'deanery' => 'Sesheke Deanery',
                'patron_matron_name' => 'Mwandi Youth Patron',
                'patron_contact' => '+260975334455',
                'camp_contingent_count' => 25,
                'camp_checked_in' => true,
            ],
            [
            ...
            [
                'name' => 'Shangombo Parish',
                'code' => 'SGP',
                'deanery' => 'Sioma Deanery',
                'patron_matron_name' => 'Shangombo Youth Patron',
                'patron_contact' => '+260979887766',
                'camp_contingent_count' => 25,
                'camp_checked_in' => true,
            ],
        ];
        ...
        $categoriesData = [
            [
                ...
                'judging_criteria' => [
                    ...
                    [
                        ...
                        'description' => 'Blending and balance of voices, audibility of parts and overall vocal control.',
                        'possible_score' => 10,
                    ],
                    [
                        'no' => 6,
                        'criterion' => 'Harmony',
                        'description' => 'Quality of harmonization, part singing and musical coordination among sections.',
                        'possible_score' => 10,
                    ],
                    [
                        'no' => 7,
                        'criterion' => 'Diction',
                        'description' => 'Clarity of words, pronunciation, articulation and enunciation.',
                        'possible_score' => 5,
                    ],
                    [
                        'no' => 8,
                        'criterion' => 'Pitch',
                        'description' => 'Accuracy and consistency of pitch throughout the performance.',
                        'possible_score' => 5,
                    ],
                    [
                        'no' => 9,
                        'criterion' => 'Conductor / Interpretation',
                        'description' => 'Conducting patterns, cueing, tempo control, musical expression and leadership.',
                        'possible_score' => 10,
                    ],
                    [
                        'no' => 10,
                        'criterion' => 'Attire',
                        'description' => 'Appropriateness, neatness, uniformity and suitability of dress to the occasion and presentation.',
                        'possible_score' => 5,
                    ],
                ],
            ],
            ...
            [
                ...
                'judging_criteria' => [
                    [
                        'no' => 1,
                        'criterion' => 'Entry and Exit',
                        'description' => 'Stage entrance/exit creativity, discipline, organization, and cultural posture.',
                        'possible_score' => 5,
                    ],
                    [
                        'no' => 2,
                        'criterion' => 'Authenticity of 3 Provincial Dances',
                        'description' => 'Accuracy in representing 3 distinct cultural dances from 3 separate Zambian provinces.',
                        'possible_score' => 25,
                    ],
                    [
                        'no' => 3,
                        'criterion' => 'Rhythm, Footwork & Synchronization',
                        'description' => 'Precision of movement, tempo adherence, body coordination, and unity of dancers.',
                        'possible_score' => 20,
                    ],
                    [
                        'no' => 4,
                        'criterion' => 'Traditional Costumes & Regalia',
                        'description' => 'Neatness, authenticity, decency, and appropriateness of cultural attire and props.',
                        'possible_score' => 15,
                    ],
                    [
                        'no' => 5,
                        'criterion' => 'Energy, Expression & Stage Craft',
                        'description' => 'Facial expressions, vitality, spatial utilization, and audience engagement.',
                        'possible_score' => 15,
                    ],
                    [
                        'no' => 6,
                        'criterion' => 'Instrumentation & Live Accompaniment',
                        'description' => 'Drumming precision, percussion tempo, singing quality, and rhythmic support.',
                        'possible_score' => 10,
                    ],
                    [
                        'no' => 7,
                        'criterion' => 'Overall Artistic Impression',
                        'description' => 'Smooth transition between dances, crowd engagement, and overall artistic excellence.',
                        'possible_score' => 10,
                    ],
                ],
            ],
            ...
            [
                ...
                'type' => 'stage_performance',
                'theme' => $festivalTheme,
                'description' => 'Stage dramatic production based on the CAM festival theme. No sharp or dangerous instruments.',
                ...
                'judging_criteria' => [
                    [
                        'no' => 1,
                        'criterion' => 'Theme Relevance & Script Writing',
                        'description' => 'Depth and clarity of pastoral message, moral value, plot structure, and dialogue.',
                        'possible_score' => 20,
                    ],
                    [
                        'no' => 2,
                        'criterion' => 'Acting & Character Portrayal',
                        'description' => 'Believability, character development, voice projection, diction, and facial/body expressions.',
                        'possible_score' => 25,
                    ],
                    [
                        'no' => 3,
                        'criterion' => 'Directing & Stage Management',
                        'description' => 'Stage blocking, spatial balance, pacing, climax development, and scene transitions.',
                        'possible_score' => 20,
                    ],
                    [
                        'no' => 4,
                        'criterion' => 'Set Design, Costumes & Props',
                        'description' => 'Creativity and suitability of backdrop, costumes, and props without safety violations.',
                        'possible_score' => 15,
                    ],
                    [
                        'no' => 5,
                        'criterion' => 'Sound Effects & Technical Execution',
                        'description' => 'Audibility of actors, effective cueing of music/sound effects, and timing.',
                        'possible_score' => 10,
                    ],
                    [
                        'no' => 6,
                        'criterion' => 'Overall Production & Audience Impact',
                        'description' => 'Emotional resonance, clarity of message delivery, and overall impact on audience.',
                        'possible_score' => 10,
                    ],
                ],
            ],
        ...
        ScheduleItem::create([
            ...
            'venue' => "St. Theresa's Cathedral",
            'activity_title' => 'CAM Festival Thanksgiving High Mass & Blessing',
            'category_id' => null,
            'parish_id' => $parishModels["St. Theresa's Cathedral"]->id,
            'performance_order' => 1,
            'status' => 'scheduled',
        ]);
